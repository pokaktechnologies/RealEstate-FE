class RentPropertiesModel {
  ...
  factory RentPropertiesModel.fromJson(Map<String, dynamic> json) {
    return RentPropertiesModel(
      ...
      dealPrice: json['deal_price'] != null ? (json['deal_price'] as num).toDouble() : null,
      dealDiscountPercentage: json['deal_discount_percentage'] != null ? (json['deal_discount_percentage'] as num).toDouble() : null,
...
class KeyFeatureModel {
  ...
  factory KeyFeatureModel.fromJson(Map<String, dynamic> json) => KeyFeatureModel(
        key: json['key'] ?? '',
        label: json['label'] ?? '',
        icon: json['icon'] ?? '',
      );
